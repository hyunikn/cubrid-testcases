...
begin
    ...
    dbms_output.put_line(length('[' || SUBSTRING_INDEX('いイ基盤','い',1) || ']'));
    dbms_output.put_line(length(SUBSTRING_INDEX('いイ基盤','盤',1)));
    dbms_output.put_line(length(SUBSTRING_INDEX('いイ基盤','詳l',2)));
    dbms_output.put_line(length(SUBSTRING_INDEX('いイ基盤','詳',-1)));
end;
